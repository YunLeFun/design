...
├── 设计基础：@yunlefun/ui 的颜色、字体、圆角、阴影和主题
...
- **极光**用于局部品牌表达：首页视觉、精选内容、明确选择的 `aurora` 变体。
...
| 场景                   | 字体角色               | 视觉强度                         |
| ---------------------- | ---------------------- | -------------------------------- |
| 品牌字、首页展示标题   | `wordmark` / `display` | 可使用展示字体与一处极光视觉     |
...
本轮统一仓库定位、包职责、主题基线、字体角色与安装文档。共享库采用晴空蓝主色，保留极光变体，文档站直接使用相同 token。
